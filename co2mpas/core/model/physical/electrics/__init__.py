...
dsp.add_dispatcher(
    ...
    inputs=(
        ...
        'service_battery_charging_statuses', 'clutch_tc_powers', 'wheel_speeds',
...
dsp.add_dispatcher(
    ...
    inputs=(
        ...
        'electrical_hybridization_degree', 'service_battery_state_of_charges',
        'dcdc_converter_electric_powers', 'motor_p1_electric_powers', 'times',
        'motor_p4_electric_powers', 'service_battery_currents', 'on_engine',
        'drive_battery_state_of_charges', 'drive_battery_n_parallel_cells',
        'motor_p0_electric_powers', 'drive_battery_capacity',
