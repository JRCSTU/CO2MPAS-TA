...
dsp.add_dispatcher(
    ...
    inputs=(
        ...
        'motor_p4_electric_powers', 'motor_p1_electric_powers', 'hybrid_modes',
        'after_treatment_warm_up_phases', 'gear_box_mean_efficiency_guess',
        ...
        'engine_speeds_out_hot', {'is_hybrid': sh.SINK},
    ),
    outputs=(
        'motor_p3_front_electric_powers', 'motor_p4_electric_powers', 'ecms_s',
        ...
        'motor_p3_rear_electric_powers', 'after_treatment_warm_up_phases',
        'engine_speeds_base', 'engine_speeds_out_hot',
    ),
