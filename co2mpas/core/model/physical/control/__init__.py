...
dsp.add_dispatcher(
    ...
    inputs=(
        ...
        'motor_p3_front_maximum_power', 'engine_coolant_temperatures',
        'motor_p3_rear_maximum_power', 'catalyst_cooling_duration',
        'motor_p4_electric_powers', 'catalyst_warm_up_phases',
    ...
    outputs=(
        ...
        'engine_speeds_out_hot', 'catalyst_warm_up_phases',
    ),
