...
dsp.add_dispatcher(
    ...
    inputs=(
        ...
        'drive_battery_nominal_voltage', 'drive_battery_electric_powers',
        'kco2_wltp_correction_factor', 'kco2_nedc_correction_factor',
        'drive_battery_capacity', 'accelerations',
    ),
    outputs=(
