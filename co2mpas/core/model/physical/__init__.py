...
dsp.add_dispatcher(
    ...
    inputs=(
        ...
        'motor_p3_speeds', 'motor_p4_speeds', 'service_battery_loads', 'times',
        ...
        'dcdc_converter_currents', 'drive_battery_loads', 'drive_battery_load',
        ...
        'service_battery_currents', 'drive_battery_capacity', 'accelerations',
...
dsp.add_dispatcher(
    ...
    dsp=_control,
    inputs=(
        'motor_p3_maximum_powers', 'start_stop_activation_time', 'is_cycle_hot',
        ...
        'start_demand_function', 'engine_speeds_out', 'auxiliaries_torque_loss',
        'final_drive_mean_efficiency', 'gear_box_mean_efficiency', 'velocities',
        'belt_mean_efficiency', 'accelerations', 'starter_efficiency', 'ecms_s',
