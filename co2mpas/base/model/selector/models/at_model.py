...
from co2mpas.base.model.physical.gear_box.at_gear import dsp as _at_gear
from co2mpas.base.model.physical.gear_box.mechanical import \
...
weights = sh.map_list(targets, -1, 0)
...
def select_models(data):
    ...
    mdl = sh.selector(set(models) - at_m, data, allow_miss=True)
...
#: Prediction model.
dsp = sh.Blueprint(_at_gear, inputs, outputs, models)
