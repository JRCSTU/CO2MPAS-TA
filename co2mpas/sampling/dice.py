...
if __name__ == '__main__':
    ...
    #argv = 'projectls--vlevel=3'.split()
    argv = 'projectls--vlevel=1'.split()
    #argv = '--debug'.split()
    #argv = 'projectls. --reset-git-settings'.split()
    ...
    #argv = 'projectls --Project.reset_git_settings=True'.split()
