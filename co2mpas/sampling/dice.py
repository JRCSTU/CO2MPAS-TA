...
if __name__ == '__main__':
    ...
    #argv = 'project list --vlevel=3'.split()
    argv = 'project list --vlevel=1'.split()
    #argv = '--debug'.split()
    #argv = 'project list --help-all'.split()
    #argv = 'project list . --reset-git-settings'.split()
    #argv = 'project examine --help-all'.split()
    #argv = 'project examine'.split()
    #argv = 'project --help-all'.split()
    #argv = 'project examine --verbose --debug'.split()
    #argv = 'project examine --Project.verbose=2 --debug'.split()
    #argv = 'project list  --Project.reset_git_settings=True'.split()
