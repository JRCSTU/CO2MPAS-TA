...
def physical():
    ...
    d.add_dispatcher(
        ...
        inputs=(
            ...
            'engine_coolant_temperatures', 'engine_mass', 'engine_max_torque',
            'engine_speed_at_max_velocity', 'engine_speeds_out',
            'engine_thermostat_temperature', 'f0', 'final_drive_ratios',
            'first_gear_box_ratio', 'fuel_saving_at_strategy',
            'full_load_curve', 'gear_box_efficiency_constants',
    ...
    d.add_dispatcher(
        ...
        outputs=(
            ...
            'idle_engine_speed_std', 'ignition_type',
            'initial_engine_temperature', 'initial_friction_params',
            'ki_factor', 'max_engine_coolant_temperature',
