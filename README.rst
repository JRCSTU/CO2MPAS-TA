...
:download:      AIO(https://github.com/JRCSTU/CO2MPAS-TA/releases/tag/v1.7.4b0)
...
1. Install |co2mpas| executable internally into your python-environment with
   ...
   .. code-block:: console
        ...
        Successfully installed co2mpas-1.7.4b0
...
2. Check that when you run |co2mpas|, the version executed is indeed the one
   ...
   .. code-block:: console
       ...
       > co2mpas -vV
       co2mpas_version: 1.7.4b0
       co2mpas_rel_date: 2017-10-06 01:44:12
