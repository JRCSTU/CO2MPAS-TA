...
:download:      AIO(https://github.com/JRCSTU/CO2MPAS-TA/releases/tag/v1.6.3b2)
...
1. Install |co2mpas| executable internally into your python-environment with
   ...
   .. code-block:: console
        ...
        Successfully installed co2mpas-1.6.3b2
...
2. Check that when you run |co2mpas|, the version executed is indeed the one
   ...
   .. code-block:: console
       ...
       > co2mpas -vV
       co2mpas_version: 1.6.3b2
       co2mpas_rel_date: 2017-07-31 18:02:42
