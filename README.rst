...
:release:       1.8.0.dev1
:rel_date:      |to2018-05-29T01:19:09.958693ome:          http://co2mpas.io/
...
1. Install |co2mpas| executable internally into your python-environment with
   ...
   .. code-block:: console
        ...
        Successfully installed co2mpas-1.8.0.dev1
...
2. Check that when you run |co2mpas|, the version executed is indeed the one
   ...
   .. code-block:: console
       ...
       > co2mpas -vV
       co2mpas_version: 1.8.0.dev1
       co2mpas_rel_date: 2018-05-29T01:19:09.958693
