...
:release:       1.6.1.dev8.0+Hc3Rc
:date:          2017-06-18 08:33:46
...
1. Install |co2mpas| executable internally into your python-environment with
   ...
   .. code-block:: console
        ...
        Successfully installed co2mpas-1.6.1.dev8.0+Hc3Rc
...
2. Check that when you run |co2mpas|, the version executed is indeed the one
   ...
   .. code-block:: console
       ...
       > co2mpas -vV
       co2mpas_version: 1.6.1.dev8.0+Hc3Rc
       co2mpas_rel_date: 2017-06-18 08:33:46
