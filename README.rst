...
:official:      `AIO-1.7.3` + `co2mpas-1.7.x` (obligatory after 31-Oct-2017)
:latest:        `1.7.3.post0`
...
:download:      AIO(https://github.com/JRCSTU/CO2MPAS-TA/releases/tag/v1.7.3.post0)
...
1. Install |co2mpas| executable internally into your python-environment with
   ...
   .. code-block:: console
        ...
        Successfully installed co2mpas-1.7.3.post0
...
2. Check that when you run |co2mpas|, the version executed is indeed the one
   ...
   .. code-block:: console
       ...
       > co2mpas -vV
       co2mpas_version: 1.7.3.post0
       co2mpas_rel_date: 2017-10-16 10:12:12
