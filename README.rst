...
:release:       1.6.1.dev2.1
:date:          2017-05-22 23:08:35
...
1. Install |co2mpas| executable internally into your python-environment with
   ...
   .. code-block:: console
        ...
        Successfully installed co2mpas-1.6.1.dev2.1
...
2. Check that when you run |co2mpas|, the version executed is indeed the one
   ...
   .. code-block:: console
       ...
       > co2mpas -vV
       co2mpas_version: 1.6.1.dev2.1
       co2mpas_rel_date: 2017-05-22 23:08:35
